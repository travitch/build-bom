...
$ build-bom normalize --output=/tmp/my-build-norm.json /tmp/my-build.json # Optional, but potentially informative
$ build-bom generate-bitcode /tmp/my-build-norm.json
